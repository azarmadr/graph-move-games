# graph-async-loading Specification
...
#### Scenario: Skeleton on tab activation
...
- **AND** the skeleton occupies the same space the graph will fill, preventing layout shift
